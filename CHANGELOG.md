...
* Backported Bugfixes from 3.5.x (see https://github.com/techdivision/import-cli-simple/blob/3.5.x/CHANGELOG.md)

## Features

* Backported Features from 3.5.x (see https://github.com/techdivision/import-cli-simple/blob/3.5.x/CHANGELOG.md)
...
* Backported Bugfixes from 3.4.x (see https://github.com/techdivision/import-cli-simple/blob/3.4.x/CHANGELOG.md)

## Features

* Backported Features from 3.4.x (see https://github.com/techdivision/import-cli-simple/blob/3.4.x/CHANGELOG.md)
...
* Backported Bugfixes from 3.1.x (see https://github.com/techdivision/import-cli-simple/blob/3.1.x/CHANGELOG.md)

## Features

* Backported Features from 3.1.x (see https://github.com/techdivision/import-cli-simple/blob/3.1.x/CHANGELOG.md)
